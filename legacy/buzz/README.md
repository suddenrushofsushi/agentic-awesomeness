# agentic-awesomeness (legacy: Buzz hub)

> Retired 2026-09-23: the local Buzz stack was unstable. See the top-level README for the current setup. Paths below are relative to this folder.
